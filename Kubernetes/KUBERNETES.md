...
## Deploy Vanitynumber Service

### Create Namespace

First, create the `vanity-robertsirre-nl` namespace:
...
```powershell
# Check pods
kubectl get pods -n vanity-robertsirre-nl -l app=vanity-robertsirre-nl

# Check service
kubectl get service -n vanity-robertsirre-nl vanity-robertsirre-nl

# Check deployment
kubectl get deployment -n vanity-robertsirre-nl vanity-robertsirre-nl
```
...
- All resources deploy to the `vanity-robertsirre-nl` namespace
