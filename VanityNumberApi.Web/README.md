...
- .NET 10 SDK
- VanityNumberApi backend running (default: https://localhost:7001)
...
The app communicates with the VanityNumberApi backend through:
...
- **Dictionaries**: Configure in `Services/VanityNumberApiService.cs`

## License

Same license as the main VanityNumberApi project.
