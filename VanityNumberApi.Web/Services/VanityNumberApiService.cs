...
namespace VanityNumberApi.Web.Services;

/// <summary>
/// Service for interacting with the Vanity Number API.
/// </summary>
public class VanityNumberApiService
{
    private readonly HttpClient _httpClient;
    private readonly JsonSerializerOptions _jsonOptions;

    /// <summary>
    /// Initializes a new instance of the <see cref="VanityNumberApiService"/> class.
    /// </summary>
    /// <param name="httpClient">The HTTP client.</param>
    public VanityNumberApiService(HttpClient httpClient)
    {
